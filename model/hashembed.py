...
class HashEmbedding(nn.Module):
    ...
    def __init__(self, num_embeddings, embedding_dim, num_buckets=None, num_hashes=2, train_sharedEmbed=True,
                 train_weight=True, append_weight=True, aggregation_mode='sum', mask_zero=False, oldAlgorithm=False, seed=2021):
    ...
    def reset_parameters(self,
                         init_shared=lambda x: torch.nn.init.normal_(x, std=0.1),
                         init_importance=lambda x: torch.nn.init.normal_(x, std=0.0005)):
